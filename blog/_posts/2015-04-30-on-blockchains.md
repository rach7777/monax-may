...
category:  blockchain
tags:      [blockchains]
excerpt:   "In this post Ethan explores Eris' definition, as well as the greater relevance, necessity, some of the use cases of that most remarkable piece of technology: the blockchain."
