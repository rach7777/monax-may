...
author:    casey
excerpt:   "Casey summarizes what he finds interesting and impactful about smart contract technology and why he is skeptical of the term to begin with."
...
[{{ page.date | date: "%Y" | append:'/contract.jpg' | img }}](https://www.flickr.com/photos/stevensnodgrass/5480863464/)
...
[{{ page.date | date: "%Y" | append:'/neverland.gif' | img }}](https://33.media.tumblr.com/6c6d7a976bfe30324d656f0465cd7add/tumblr_nk1e8rM4ie1u17yx1o1_500.gif)
...
This post is a [semi-follow on to my WTF is going on with blockchains post](https://db.erisindustries.com/strategy/2015/08/10/how-i-current-explain-blockchains/).
