...
Unlike other projects in the space, however, there is no "pre-sale" and there are no tokens. Indeed, there is no reason that - unlike practically every other blockchain project in existence - an Eris platform should ever be anything but free to use.
