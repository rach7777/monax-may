...
Unlike other projects in the space, however, there is no "pre-sale" and there are no tokens. Indeed, there is no reason that an Eris platform should ever be anything but free to use.
